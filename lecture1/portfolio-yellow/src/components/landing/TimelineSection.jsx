...
const CAREER = [
  { label: '노란지붕 스튜디오', role: '프론트엔드 개발자', period: '2024.03 - 현재' },
  { label: '테라스 커넥트', role: '웹 퍼블리셔', period: '2022.06 - 2024.02' },
  { label: '프리랜서', role: '개인·소규모 브랜드 웹사이트 제작', period: '2021.01 - 2022.05' },
];
